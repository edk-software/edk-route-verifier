...
Commands:
  ...
  edk-route-verifier browser                     Run browser version of the verifer
...
Examples:
  ...
  edk-route-verifier file -c config.json -l pl -d my_route.kml  verifies my_route.kml and provides debug information in
                                                                Polish language
  edk-route-verifier browser                                    starts API and static web content server
