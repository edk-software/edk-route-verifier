...
describe('Positive', () => {
    test('Regular path', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('01-regular')).then(({ routeCharacteristics, verificationStatus }) => {
    ...
    test('Circular route', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('02-circular')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Zero-leading station numbers', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('03-zero_leading')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Route with shared parts #1', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('04-shared_parts')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Route with shared parts #2', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('05-shared_parts')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Stations in reversed order comparing to path direction', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('06-reversed_path')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Circular path', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('12-circular_path')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
                expect(verificationStatus.pathLength.value).toBeWithinRange(37, 0.5);
                expect(verificationStatus.routeType.valid).toEqual(true);
                expect(verificationStatus.routeType.value).toEqual(0);
    ...
    test('15 stations', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('22-15_stations')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Short distance between station 1 and 14', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('24-Short_distance_between_1_14')).then(
                ({ routeCharacteristics, verificationStatus }) => {
                    expect(verificationStatus.singlePath.valid).toEqual(true);
                    expect(verificationStatus.pathLength.value).toBeWithinRange(40, 1);
                    expect(verificationStatus.routeType.valid).toEqual(true);
                    expect(verificationStatus.routeType.value).toEqual(0);
    ...
    test('Eight-shaped route', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('25-eight_shaped_route')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
...
describe('Negative', () => {
    test('Duplicated station point', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('10-duplicated_station_point')).then(
                ({ routeCharacteristics, verificationStatus }) => {
                    expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('Station out of path', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('11-station_out_of_path')).then(
                ({ routeCharacteristics, verificationStatus }) => {
                    expect(verificationStatus.singlePath.valid).toEqual(true);
    ...
    test('One path and no stations', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('14-one_path_no_stations')).then(
                ({ routeCharacteristics, verificationStatus }) => {
                    expect(verificationStatus.singlePath.valid).toEqual(true);
                    expect(verificationStatus.pathLength.value).toBeWithinRange(44, 1);
                    expect(verificationStatus.routeType.valid).toEqual(true);
    ...
    test('No lineString tag in KML file', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('15_no_path')).then(({ routeCharacteristics, verificationStatus }) => {
    ...
    test('Duplicated path', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('20-duplicated_path')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(false);
                expect(verificationStatus.pathLength.value).toBeWithinRange(52, 1);
                expect(verificationStatus.routeType.valid).toEqual(true);
                expect(verificationStatus.routeType.value).toEqual(0);
    ...
    test('Two paths', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('21-two_path')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(false);
    ...
    test('13 stations', () =>
        new Promise(done =>
            callVerifyApi(readKmlFile('23-13_stations')).then(({ routeCharacteristics, verificationStatus }) => {
                expect(verificationStatus.singlePath.valid).toEqual(true);
                expect(verificationStatus.pathLength.value).toBeWithinRange(40, 1);
                expect(verificationStatus.routeType.valid).toEqual(true);
                expect(verificationStatus.routeType.value).toEqual(0);
